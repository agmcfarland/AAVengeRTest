...
def test_set_working_dir_tree(setup_temp_dir):
	...
	manager = InputManager(working_dir, 'test_user', 'test_docker', 'path/to/AAVengeR', None, None)
...
def test_load_test_data_sheet(example_input_manager_read_write, project_test_data_directory):
	"""
	pytest -sv tests/unit/test_input_manager.py::test_load_test_data_sheet
	"""
	example_input_manager_read_write.load_test_data_sheet(pjoin(project_test_data_directory, 'ete_correct_input_sheet.csv'))
	
	assert str(type(example_input_manager_read_write.df_test_data)) == "<class 'pandas.core.frame.DataFrame'>"


def test_validate_test_data_input_sheet(example_input_manager_read_write, project_test_data_directory):
	"""
...
def test_validate_test_data_input_sheet_errors(example_input_manager_read_write, project_test_data_directory):
	"""
	...
	with pytest.raises(ValueError) as e_info:
		example_input_manager_read_write.df_test_data['sample_sheet_path'] = ['/doesnotexist/here.tsv', '/doesnotexist/here.tsv']
		example_input_manager_read_write.validate_sample_sheet_paths()


def test_validate_test_data_input_sheet(example_input_manager_read_write, project_test_data_directory, setup_temp_dir):
	"""
	pytest -sv tests/unit/test_input_manager.py::test_validate_test_data_input_sheet
	"""
	example_input_manager_read_write.load_test_data_sheet(pjoin(project_test_data_directory, 'ete_correct_input_sheet.csv'))
...
def test_validate_test_data_record_run(example_input_manager_read_write, project_test_data_directory, setup_temp_dir):
	"""
